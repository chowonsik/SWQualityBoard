...
class SystemControllerTest {
    ...
    public void 시스템_SW_품질지표_조회_성공() throws Exception {
        //given
        String string = "2021-11-03T00:30:13.976";
        ...
        Memo memo = Memo.builder()
                ...
                .systemQualityId("6184c7e317060cc9e4117dc0")
                .userId("6184d96139ab91305d6fb8de")
                .content("테스트입니다")
                .createdAt(date)
                .updatedAt(date)
                .build();
                        ...
                        document(
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.[].system.name").type(JsonFieldType.STRING)
                                                .description("시스템 이름"),
                                        fieldWithPath("result.[].system.createdAt").type(JsonFieldType.STRING)
                                                .description("시스템 생성일"),
                                        fieldWithPath("result.[].system.updatedAt").type(JsonFieldType.STRING)
                                                .description("시스템 수정일"),
                                        ...
                                        fieldWithPath("result.[].memo.id").type(JsonFieldType.STRING).optional()
                                                .description("메모 번호"),
                                        fieldWithPath("result.[].memo.systemQualityId").type(JsonFieldType.STRING).optional()
                                                .description("메모한 시스템 SW 품질지표 이력 번호"),
                                        fieldWithPath("result.[].memo.userId").type(JsonFieldType.STRING).optional()
                                                .description("메모한 유저 번호"),
                                        fieldWithPath("result.[].memo.content").type(JsonFieldType.STRING).optional()
                                                .description("메모 내용"),
                                        fieldWithPath("result.[].memo.createdAt").type(JsonFieldType.STRING).optional()
                                                .description("메모 생성일"),
                                        fieldWithPath("result.[].memo.updatedAt").type(JsonFieldType.STRING).optional()
                                                .description("메모 수정일"),
